...
public class PantallaPrincipalAdmin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblNombre);
        lblNombre.setBounds(620, 180, 200, 40);
        ...
        add(lblApellidoP);
        lblApellidoP.setBounds(840, 180, 200, 40);
        ...
        add(lblApellidoM);
        lblApellidoM.setBounds(1060, 180, 200, 40);
        ...
        add(lblCalle);
        lblCalle.setBounds(620, 285, 200, 40);
        ...
        add(lblNumero);
        lblNumero.setBounds(840, 390, 220, 40);
        ...
        add(lblPuesto);
        lblPuesto.setBounds(620, 480, 180, 40);
        ...
        add(lblSueldo);
        lblSueldo.setBounds(840, 480, 190, 40);
