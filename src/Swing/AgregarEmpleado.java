...
public class AgregarEmpleado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(LbPass1);
        LbPass1.setBounds(390, 620, 170, 20);
        ...
        add(LbNombre1);
        LbNombre1.setBounds(30, 320, 280, 18);
        ...
        add(LbNombre2);
        LbNombre2.setBounds(80, 340, 170, 18);
        ...
        add(LbApellidoM1);
        LbApellidoM1.setBounds(670, 320, 270, 18);
        ...
        add(LbApellidoM2);
        LbApellidoM2.setBounds(690, 340, 240, 18);
        ...
        add(LbApellidoP1);
        LbApellidoP1.setBounds(350, 320, 270, 18);
        ...
        add(LbApellidoP2);
        LbApellidoP2.setBounds(370, 340, 240, 18);
        ...
        add(LbColonia1);
        LbColonia1.setBounds(30, 480, 270, 18);
        ...
        add(LbColonia2);
        LbColonia2.setBounds(90, 500, 170, 18);
        ...
        add(LbNoCalle1);
        LbNoCalle1.setBounds(660, 480, 290, 20);
        ...
        add(LbNoCalle2);
        LbNoCalle2.setBounds(770, 500, 39, 18);
        ...
        add(LbTelefono1);
        LbTelefono1.setBounds(990, 480, 250, 18);
        ...
        add(LbTelefono2);
        LbTelefono2.setBounds(1000, 500, 230, 16);
        ...
        add(LbTelefono3);
        LbTelefono3.setBounds(1050, 520, 150, 16);
        ...
        add(LbCorreo);
        LbCorreo.setBounds(70, 620, 180, 18);
        ...
        add(LbCorreoRep);
        LbCorreoRep.setBounds(60, 640, 200, 18);

        LbCampos.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        LbCampos.setForeground(new java.awt.Color(255, 0, 0));
        LbCampos.setText("Llene todos los campos ");
        add(LbCampos);
        LbCampos.setBounds(730, 630, 170, 18);
